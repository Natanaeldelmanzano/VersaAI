...
class MessageUpdate(BaseModel):
    ...
    extra_data: Optional[Dict[str, Any]] = Field(None, description="Message extra data")
...
class MessageInDBBase(MessageBase):
    ...
    extra_data: Dict[str, Any] = Field(default_factory=dict, description="Message extra data")
...
class ConversationInDBBase(ConversationBase):
    ...
    user_name: Optional[str] = Field(None, description="User name for anonymous users")
    user_email: Optional[str] = Field(None, description="User email for anonymous users")
    ...
    extra_data: Dict[str, Any] = Field(default_factory=dict, description="Additional conversation data")
    created_at: datetime = Field(..., description="Creation timestamp")
    updated_at: datetime = Field(..., description="Last update timestamp")
